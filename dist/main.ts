...
import MainMenu from "../outside-the-box/Scenes/MainMenuScene";
import {TYSControls} from "../outside-the-box/TYSControls";
...
(function main(){
    ...
    let options = {
        ...
        inputs: [
            { name: TYSControls.MOVE_UP, keys: ["w"] },   // Forward is assigned to w
            { name: TYSControls.MOVE_DOWN, keys: ["s"] },  // and so on...
            { name: TYSControls.MOVE_LEFT, keys: ["a"] },
            { name: TYSControls.MOVE_RIGHT, keys: ["d"] },
        ],
