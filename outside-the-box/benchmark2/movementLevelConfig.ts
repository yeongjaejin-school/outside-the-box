...
export const MOVEMENT_LEVEL_CONFIG: Record<number, MovementLevelConfig> = {
  11: {
    ...
    blocks: [
      ...
      { x: 0.74, y: 0.54, value: "c", type: "normal" },
    ],
  },
  12: {
    prompt: "Find the hidden block and spell MAPA.",
    answer: "MAPA",
    time: 40,
    blocks: [
      ...
      { x: 0.74, y: 0.56, value: "A", type: "invisible" },
    ],
  },
  13: {
  ...
  14: {
    ...
    blocks: [
      ...
      { x: 0.42, y: 0.42, value: "K", type: "glass" },
      { x: 0.64, y: 0.30, value: "Y", type: "glass" },
  ...
  15: {
    ...
    time: 32,
    blocks: [
      { x: 0.18, y: 0.26, value: 5, type: "countdown" },
      { x: 0.38, y: 0.48, value: 3, type: "countdown" },
      { x: 0.60, y: 0.30, value: 4, type: "countdown" },
      { x: 0.11, y: 0.90, value: "1", type: "invisible"},
      { x: 0.78, y: 0.52, value: "A", type: "normal" },
    ],
  },
  16: {
    prompt: "Spell lIlIlI using mixed block types.",
    answer: "lIlIlI",
    time: 42,
    blocks: [
      { x: 0.16, y: 0.28, value: "l", type: "heavy" },
      { x: 0.42, y: 0.52, value: "I", type: "invisible" },
      { x: 0.66, y: 0.30, value: "l", type: "glass" },
      { x: 0.78, y: 0.54, value: "I", type: "glass" },
      { x: 0.11, y: 0.90, value: "l", type: "invisible" },
  ...
  17: {
    ...
    blocks: [
      ...
      { x: 0.38, y: 0.42, value: "U", type: "normal" },
  ...
  18: {
    ...
    time: 42,
    blocks: [
      { x: 0.14, y: 0.30, value: "F", type: "invisible" },
      { x: 0.36, y: 0.48, value: "O", type: "invisible" },
  ...
  19: {
    ...
    time: 34,
    blocks: [
      { x: 0.18, y: 0.28, value: 11, type: "countdown" },
      { x: 0.40, y: 0.48, value: 2, type: "countdown" },
