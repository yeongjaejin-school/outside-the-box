...
export const MOVEMENT_LEVEL_CONFIG: Record<number, MovementLevelConfig> = {
  ...
  17: {
    ...
    blocks: [
      ...
      { x: 0.85, y: 0.25, value: "X", type: "normal" },
    ],
  },
  18: {
    prompt: "I have no more blocks. Just quickly type 1.",
    answer: "ONE",
    time: 30,
    blocks: [
  ...
  19: {
    ...
    time: 30,
    blocks: [
      { x: 0.18, y: 0.28, value: "O", type: "invisible" },
      { x: 0.40, y: 0.48, value: "T", type: "glass" },
      { x: 0.62, y: 0.30, value: "B", type: "heavy" },
      { x: 0.78, y: 0.56, value: "A", type: "normal" },
    ],
  },
  20: {
    ...
    time: 10,
    blocks: [
      { x: 0.14, y: 0.28, value: 2, type: "countdown" },
      { x: 0.32, y: 0.48, value: 3, type: "countdown" },
      { x: 0.52, y: 0.28, value: 4, type: "countdown" },
      { x: 0.70, y: 0.48, value: 5, type: "countdown" },
      { x: 0.82, y: 0.30, value: 1, type: "countdown" },
    ],
  },
};
