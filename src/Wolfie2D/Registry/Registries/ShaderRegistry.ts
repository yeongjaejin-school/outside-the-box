...
export default class ShaderRegistry extends Registry<ShaderType> {
	...
	public preload(){
		...
		this.registerAndPreloadItem(ShaderRegistry.POINT_SHADER, PointShaderType, "demo_assets/shaders/point.vshader", "demo_assets/shaders/point.fshader");

		// Queue a load for the rect shader
		this.registerAndPreloadItem(ShaderRegistry.RECT_SHADER, RectShaderType, "demo_assets/shaders/rect.vshader", "demo_assets/shaders/rect.fshader");

		// Queue a load for the sprite shader
		this.registerAndPreloadItem(ShaderRegistry.SPRITE_SHADER, SpriteShaderType, "demo_assets/shaders/sprite.vshader", "demo_assets/shaders/sprite.fshader");
	
		// Queue a load for the label shader
		this.registerAndPreloadItem(ShaderRegistry.LABEL_SHADER, LabelShaderType, "demo_assets/shaders/label.vshader", "demo_assets/shaders/label.fshader");
